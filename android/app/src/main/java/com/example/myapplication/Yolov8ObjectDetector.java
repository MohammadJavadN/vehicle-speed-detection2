...
//        return objectDetector;
        ...
        try {
            ...
            associatedAxisLabels = FileUtil.loadLabels(activity, LABEL_FILE); // TODO
    ...
    public ArrayList<Recognition> detect(Bitmap bitmap) {
        ...
        if(IS_INT8){
            ...
            imageProcessor =
                    new ImageProcessor.Builder()
                            ...
                            .add(new NormalizeOp(0, 255))
                            .build();
            yolov8nTfliteInput = new TensorImage(DataType.FLOAT32);
        }

        yolov8nTfliteInput.load(bitmap);
        yolov8nTfliteInput = imageProcessor.process(yolov8nTfliteInput);
        ...
        if (null != tflite) {
            ...
            Log.d(">>> ", yolov8nTfliteInput.getTensorBuffer().getFlatSize() + " " + probabilityBuffer.getFlatSize());
            tflite.run(yolov8nTfliteInput.getBuffer(), probabilityBuffer.getBuffer());
        }
